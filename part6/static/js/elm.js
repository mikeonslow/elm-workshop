...
var author$project$Main$Item = F7(
	function (id, title, categoryId, imageUrl, linkUrl, description, overlayColor) {
		return {categoryId: categoryId, description: description, id: id, imageUrl: imageUrl, linkUrl: linkUrl, overlayColor: overlayColor, title: title};
	});
...
var author$project$Main$initialModel = function (url) {
	return {
		apiUrl: url,
		errorMessage: '',
		portfolio: {categories: _List_Nil, items: _List_Nil}
	};
};
var author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		author$project$Main$initialModel(flags.apiUrl),
		author$project$Main$getPortfolio(flags.apiUrl));
};
	...
	function (msg, model) {
		if (msg.$ === 'ApiResponse') {
			...
			if (response.$ === 'Ok') {
				...
				var updatedModel = _Utils_update(
					model,
					{errorMessage: 'An error occurred while attempted to fetch your portfolio'});
				return _Utils_Tuple2(updatedModel, elm$core$Platform$Cmd$none);
			}
		} else {
...
_Platform_export({'Main':{'init':author$project$Main$main(
	A2(
		...
		A2(elm$json$Json$Decode$field, 'apiUrl', elm$json$Json$Decode$string)))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Main.Category":{"args":[],"type":"{ id : Basics.Int, label : String.String }"},"Main.Item":{"args":[],"type":"{ id : Basics.Int, title : String.String, categoryId : Basics.Int, imageUrl : String.String, linkUrl : String.String, description : String.String, overlayColor : String.String }"},"Main.Portfolio":{"args":[],"type":"{ categories : List.List Main.Category, items : List.List Main.Item }"},"Http.Response":{"args":["body"],"type":"{ url : String.String, status : { code : Basics.Int, message : String.String }, headers : Dict.Dict String.String String.String, body : body }"}},"unions":{"Main.Msg":{"args":[],"tags":{"ApiResponse":["Result.Result Http.Error Main.Portfolio"],"None":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Http.Response String.String"],"BadPayload":["String.String","Http.Response String.String"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));