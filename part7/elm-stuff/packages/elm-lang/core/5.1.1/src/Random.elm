...
> _Note:_ This is an implementation of the Portable Combined Generator of
...
This function _can_ produce values outside of the range [[`minInt`](#minInt),
...
To actually _run_ a generator and produce the random values, you need to use
...
seed. This will produce a random number and a _new_ seed to use if we want to
