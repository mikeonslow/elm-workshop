...
import Native.Debug
import VirtualDom.Helpers as VDom exposing (Node, class, div, onClick, span, text)
                    ...
                    case entry of
                        ...
                        Sequence _ _ subValueList ->
                            ...
                            , if isClosed then
                                ...
                                VDom.map (Index None 0) (viewSequenceOpen subValueList)
                            )
                        ...
                        Dictionary _ keyValuePairs ->
                            ...
                            , if isClosed then
                                ...
                                VDom.map (Index None 0) (viewDictionaryOpen keyValuePairs)
                            )
                        ...
                        Record _ record ->
                            ...
                            , if isClosed then
                                ...
                                VDom.map (Index None 0) (viewRecordOpen record)
                            )
                        ...
                        Constructor _ _ subValueList ->
                            ...
                            , if isClosed then
                                ...
                                VDom.map (Index None 0) (viewConstructorOpen subValueList)
                            )
...
viewTiny value =
    case value of
        ...
        Dictionary _ keyValuePairs ->
            viewTinyHelp <|
                "Dict("
                    ++ toString (List.length keyValuePairs)
                    ++ ")"
